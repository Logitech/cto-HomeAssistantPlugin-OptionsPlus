namespace Loupedeck.HomeAssistantPlugin
{
    ...
    internal static class PluginResources
    {
        ...
        // The parameter `folderName` must be specified as a full path, for example, `Loupedeck.HomeAssistantPlugin.Resources`.
        // Returns the full names of the resource files, for example, `Loupedeck.HomeAssistantPlugin.Resources.Resource.txt`.
